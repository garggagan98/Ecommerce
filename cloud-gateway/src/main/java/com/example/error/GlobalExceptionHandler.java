...
public class GlobalExceptionHandler extends AbstractErrorWebExceptionHandler {
	...
	private Mono<ServerResponse> formatErrorResponse(ServerRequest request) {
		...
		ErrorAttributeOptions errorAttributeOptions = null;
		if (isTraceEnabled(query)) {
			errorAttributeOptions = ErrorAttributeOptions.of(Include.STACK_TRACE);
		} else
	...
	private boolean isTraceEnabled(String q) {
		return !StringUtils.isEmpty(q) && q.contains("trace=true");
	}
}
