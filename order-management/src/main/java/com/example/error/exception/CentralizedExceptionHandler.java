...
public class CentralizedExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({ CartIsEmptyException.class, AuthorizationException.class, ResourceNotFoundException.class,
			Exception.class })
	public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) {
		...
		} else if (ex instanceof CartIsEmptyException) {
			return new ResponseEntity<>(
					new ErrorResponse(HttpStatus.BAD_REQUEST.value(), ErrorCodes.CART_IS_EMPTY, "Cart is empty"),
					HttpStatus.BAD_REQUEST);
		} else {
